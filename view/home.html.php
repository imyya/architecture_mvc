        ...
        <div class="container" >
            <div class="flex flex-col " style="background-color:rgb(209, 195, 179); height: 100%; width: 100%;">
                ...
                <div class="flex space-around" style="padding-top: 1.5rem;" >
                    <a href="" style="font-size: 1.4rem; text-decoration: none; font-weight: bold; color: rgb(88, 76, 33); padding: 0.5rem;">Accueil</a>
                    <a href="" style="font-size: 1.4rem; text-decoration: none; font-weight: bold; color: rgb(88, 76, 33); padding: 0.5rem;">Actualite</a>
                    <a href="" style="font-size: 1.4rem; text-decoration: none; font-weight: bold; color: rgb(88, 76, 33); padding: 0.5rem;">Sport</a>
